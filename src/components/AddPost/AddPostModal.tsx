    ...
    <div className="modal" onClick={onClose}>
      <div className="modal-dialog" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="modal-content">
            <textarea
              ...
              className={
                "modal-textarea " +
                (!isTextValid ? "modal-textarea__error" : "")
              }
              value={text}
          ...
          {!isTextValid ? (
            <p className="modal-content__error">
              The number of characters must be less than 200
            </p>
          ) : (
            ""
          )}
        ...
        <div className="modal-footer">
          ...
          <button onClick={onHandleAddPost} disabled={!isTextValid}>
            Add post
          </button>
        </div>
      </div>
